...
ALTER TABLE `booking_seat_holds` ADD CONSTRAINT `booking_seat_holds_showtime_id_show_times_id_fk` FOREIGN KEY (`showtime_id`) REFERENCES `show_times`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
